...
impl<P: Preset> Network<P> {
    pub async fn new(
        ...
        let (gossipsub, update_gossipsub_scores) = {
            ...
            let filter = gossipsub::MaxCountSubscriptionFilter {
                ...
                // 209 in theory = (64 attestation + 4 sync committee + 7 core topics + 6 blob topics + 64 column topics) * 2                max_subscriptions_per_request: max_topics * 2,
        ...
        let swarm = {
            let config = libp2p::swarm::Config::with_executor(Executor(executor))
                ...
                .with_dial_concurrency_factor(std::num::NonZeroU8::new(1).expect("Not zero"));
    ...
    pub fn send_response(&mut self, peer_id: PeerId, id: PeerRequestId, response: Response<P>) {
        self.eth2_rpc_mut()

...
pub struct Config {
    ...
    /// Version passed to [`libp2p::identify::IdentifyConfig::with_agent_version`]
    ...
    /// A setting specifying a range of values that tune the network parameters. The
...
/// Controls sizes of gossipsub meshes to tune bandwidth/performance.
...
pub fn gossipsub_config(
    ...
    fn prefix(
        ...
        match fork_context.current_fork() {
            ...
            Phase::Altair | Phase::Bellatrix | Phase::Capella | Phase::Deneb | Phase::Electra | Phase::Fulu => {
